/**
 * @file       asset_passive_buzzer_notes.h
 * @copyright  Copyright (C) 2025 Diep Tran Van. All rights reserved.
 * @version    1.0.0
 * @date       2025-09-29
 * @author     Diep Tran Van
 *             
 * @brief      Musical notes frequency definitions for passive buzzer
 *             This file contains frequency definitions for musical notes
 *             from octave 3 to octave 6, commonly used for passive buzzer applications
 * @note       All frequencies are defined in Hz (Hertz)
 */

/* Define to prevent recursive inclusion ------------------------------ */
#ifndef __ASSET_PASSIVE_BUZZER_NOTES_H
#define __ASSET_PASSIVE_BUZZER_NOTES_H
...
#define FREQ_WARNING        1500  /*!< Warning sound frequency */
#define FREQ_BEEP           1000 /*!< Standard beep frequency */
#define FREQ_ERROR          300  /*!< Error sound frequency */
#define FREQ_LOW_SUCCESS    500  /*!< Low success sound frequency */
#define FREQ_MID_SUCCESS    700  /*!< Mid success sound frequency */
#define FREQ_HIGH_SUCCESS   900  /*!< High success sound frequency */
...
#endif // __ASSET_PASSIVE_BUZZER_NOTES_H
