/**
 * @file       driver_passive_buzzer.h
 * @copyright  Copyright (C) 2025 Diep Tran Van. All rights reserved.
 * @version    1.0.0
 * @date       2025-09-29
 * @author     Diep Tran Van
 *             
 * @brief      Passive buzzer driver for STM32 microcontrollers
 *             This driver provides a hardware abstraction layer for controlling
 *             passive buzzers using STM32 timer with PWM capability
 * @note       This driver is designed for passive buzzers with PWM control
 */

/* Define to prevent recursive inclusion ------------------------------ */
#ifndef __DRIVER_PASSIVE_BUZZER_H
#define __DRIVER_PASSIVE_BUZZER_H
...
/* STM32 HAL Timer includes - User must include appropriate HAL header before this file */
/* For STM32F1: #include "stm32f1xx_hal.h" */
...
//   #include "stm32f4xx_hal_tim.h"
// #else
//   /* User must include appropriate STM32 HAL Timer header */
//   #ifndef TIM_HandleTypeDef
//     #error "Please include STM32 HAL header (e.g., stm32f1xx_hal.h or stm32f4xx_hal.h) before including this driver"
//   #endif
// #endif
...
#endif // __DRIVER_PASSIVE_BUZZER_H
